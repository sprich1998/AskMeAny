# frontend-realtime-ws Specification

## Purpose

Real WebSocket implementation of the frontend timeline hook, subscribing to backend `/ws` and mapping `TimelineEventEnvelope` messages to UI view types.
